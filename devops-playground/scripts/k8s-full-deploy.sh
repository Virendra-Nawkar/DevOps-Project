...
docker save devops-playground:latest | sudo /usr/local/bin/k3s ctr images import -
docker save devops-router:latest     | sudo /usr/local/bin/k3s ctr images import -
